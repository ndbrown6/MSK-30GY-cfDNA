---
title: "Figure 2 - Multimodal ctDNA and imaging in HPV-related OPC"
author:
  - name: David Brown
output:
  html_document:
...
```{r load_30gy_data_insert_size_and_read_pairs, eval = TRUE, include = FALSE}
...
```{r plot_30gy_number_reads_pairs, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 3, fig.width = 2.55, fig.cap = '<br/>**Figure 2c** '}

plot_ = insert_metrics_by_gene %>%
		...
		dplyr::group_by(sample_name) %>%
		dplyr::summarize(READ_PAIRS = sum(READ_PAIRS)) %>%
...
```{r plot_30gy_mean_insert_size, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 3, fig.width = 2.25, fig.cap = '<br/>**Supplementary Figure S2b** '}
...
```{r load_30gy_data_barplot, eval = TRUE, include = FALSE}
...
```{r plot_30gy_barplot, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 3, fig.width = 2.25, fig.cap = '<br/>**Supplementary Figure S2a** '}
