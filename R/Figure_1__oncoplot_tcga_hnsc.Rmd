...
```{r plot_tcga_oncoprint, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 5, fig.width = 9, fig.cap = '<br/>**Figure 1(b)** Somatic variants in TCGA head and neck squamous cell carcinoma'}
...
```{r plot_tcga_saturation_curve, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 3.5, fig.width = 5, fig.cap = '<br/>**Figure 1(c)** Saturation curve in TCGA head and neck squamous cell carcinoma'}
...
```{r plot_30gy_oncoprint, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 5, fig.width = 3.5, fig.cap = '<br/>**Figure S1(a)** Somatic variants in 30Gy head and neck HPV positive cancers'}
...
```{r plot_30gy_saturation_curve, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 3.5, fig.width = 5, fig.cap = '<br/>**Figure S1(b)** Saturation curve in 30Gy head and neck HPV positive cancers'}
