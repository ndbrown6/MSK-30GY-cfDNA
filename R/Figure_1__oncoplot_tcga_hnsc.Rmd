...
```{r plot_30gy_oncoprint, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 5, fig.width = 3.5, fig.cap = '<br/>**Supplementary Figure S1a** Recurrrent somatic variants in 30Gy head and neck HPV positive cancers'}
...
```{r plot_30gy_saturation_curve, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, fig.align = 'left', fig.height = 3.5, fig.width = 5, fig.cap = '<br/>**Supplementary Figure S1b** Fraction of patients captured in 30Gy head and neck HPV positive cancers'}
