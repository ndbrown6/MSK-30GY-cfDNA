...
pdf(file = "../res/Number_Read_Pairs_by_Wk.pdf", width = 3*1.25, height = 2.5*1.25)
print(plot_)
dev.off()
...
pdf(file = "../res/Mean_AF_by_Wk.pdf", width = 3*1.25, height = 2.5*1.25)
print(plot_)
dev.off()
...
pdf(file = "../res/MRI_Volume_by_Wk.pdf", width = 3*1.25, height = 2.5*1.25)
print(plot_)
dev.off()
