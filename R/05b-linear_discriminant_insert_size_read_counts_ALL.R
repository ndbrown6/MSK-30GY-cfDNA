...
pdf(file = "../res/Posterior_Probability_Training_HPV-16_Positive.pdf", width = 4, height = 5)
print(plot_)
dev.off()
...
pdf(file = "../res/Posterior_Probability_Training_HPV-16_Negative.pdf", width = 4, height = 5)
print(plot_)
dev.off()
...
pdf(file = "../res/Posterior_Probability_Test_HPV-16_Negative.pdf", width = 4, height = 5)
print(plot_)
dev.off()